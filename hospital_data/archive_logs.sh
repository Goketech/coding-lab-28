...
case $choice in
    1)
        original="/coding-lab-28/hospital_data/active_logs/heart_rate_log.log"
        archive_dir="/coding-lab-28/hospital_data/archived_logs/heart_data_archive"
        ...
        ;;
    2)
        original="/coding-lab-28/hospital_data/active_logs/temperature_log.log"
        archive_dir="/coding-lab-28/hospital_data/archived_logs/temperature_data_archive"
        ...
        ;;
    3)
        original="/coding-lab-28/hospital_data/active_logs/water_usage_log.log"
        archive_dir="/coding-lab-28/hospital_data/archived_logs/water_usage_data_archive"
